...
<body onresize="checaDispositivo()" onload="checaDispositivo()">
    ...
    <section class="container-fluid row map">
      ...
      <div class="col-md descMap">
        ...
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras quam nisi, eleifend et interdum sed,
          scelerisque sed tortor. </p>
        <a href="">MAPA</a>
      </div>
    </section>
    ...
    <section class="container-fluid row inst">
      <div>
